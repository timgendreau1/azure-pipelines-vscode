...
export function activate(context: ExtensionContext) {
    ...
    // TODO: Do the workspace settings get passed through to the server?

    // TODO: Always look for .vsts-ci.yml as a schema, pass to server?

    // TODO: Point to local schema file

    // TODO: Move settings here so that the user doesn't have to specify them
